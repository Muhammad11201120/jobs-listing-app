        ...
        <section className="py-4 ">
            <div className="container-xl lg:container m-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg">
                    <Card bg=" bg-gradient-to-l from-emerald-400/60">
                    ...
                    <Card bg=" bg-gradient-to-l from-emerald-400/20">
                        ...
                        <Link
                            to="/add-job"
                            className="inline-block bg-gray-900 text-white rounded-lg px-4 py-2 hover:bg-indigo-600"
                        >
                            وظيفة جديدة{" "}
                        </Link>
                    </Card>
